...
#define PD_PORT1_PHY_INTERRUPT_PIN  (23U)
#define PD_PORT1_PHY_INTERRUPT_PORT (0U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN  (17U)
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (3U)

#define PD_PORT1_EXTRA_SRC_PIN  (21U)
#define PD_PORT1_EXTRA_SRC_PORT (0U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN  (0U)
#define PD_PORT1_SHIELD2_DP4LANE_PORT (2U)

#define PD_PORT1_SHIELD2_XSD_PIN  (7U)
#define PD_PORT1_SHIELD2_XSD_PORT (2U)

#define PD_PORT1_SHIELD2_ORIENT_PIN  (14U)
#define PD_PORT1_SHIELD2_ORIENT_PORT (3U)

#define PD_PORT1_SHIELD2_HPD_PIN  (12U)
#define PD_PORT1_SHIELD2_HPD_PORT (3U)
