...
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN (12U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (2U)

#define PD_PORT1_EXTRA_SRC_PIN (10U)

#define PD_PORT1_EXTRA_SRC_PORT (1U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN (2U)

#define PD_PORT1_SHIELD2_DP4LANE_PORT (1U)

#define PD_PORT1_SHIELD2_XSD_PIN (11U)

#define PD_PORT1_SHIELD2_XSD_PORT (1U)

#define PD_PORT1_SHIELD2_ORIENT_PIN (7U)

#define PD_PORT1_SHIELD2_ORIENT_PORT (3U)

#define PD_PORT1_SHIELD2_HPD_PIN (9U)
