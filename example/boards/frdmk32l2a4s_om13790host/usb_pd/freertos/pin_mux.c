...
- pin_list:
  ...
  - {pin_num: '99', peripheral: GPIOD, signal: 'GPIO, 6', pin_signal: ADC0_SE7b/PTD6/LLWU_P15/LPSPI1_SOUT/LPUART0_RX/FXIO0_D6, direction: INPUT}
  - {pin_num: '60', peripheral: GPIOB, signal: 'GPIO, 10', pin_signal: PTB10/LPSPI1_PCS0/FXIO0_D14, direction: OUTPUT}
  - {pin_num: '84', peripheral: GPIOC, signal: 'GPIO, 12', pin_signal: PTC12/LPI2C1_SCLS/TPM0_CLKIN}
  - {pin_num: '55', peripheral: GPIOB, signal: 'GPIO, 2', pin_signal: ADC0_SE12/TSI0_CH7/PTB2/LPI2C0_SCL/TPM2_CH0/LPUART0_RTS_b/FXIO0_D10, direction: OUTPUT}
  - {pin_num: '61', peripheral: GPIOB, signal: 'GPIO, 11', pin_signal: PTB11/LPSPI1_SCK/TPM2_CLKIN/FXIO0_D15, direction: OUTPUT}
  - {pin_num: '100', peripheral: GPIOD, signal: 'GPIO, 7', pin_signal: PTD7/LPSPI1_SIN/LPUART0_TX/FXIO0_D7, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpiob_pin61_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB11 (pin 61)  */
    GPIO_PinInit(GPIOB, 11U, &gpiob_pin61_config);
