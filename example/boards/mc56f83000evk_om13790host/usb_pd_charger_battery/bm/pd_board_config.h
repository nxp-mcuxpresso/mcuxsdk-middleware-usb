...
#define PD_DEMO_EXPECTED_VOLTAGE (5U * 1000U)  /* 5V */
#define PD_DEMO_EXPECTED_CURRENT (3000U)       /* 3A */
...
#define PD_PORT1_PHY_INTERRUPT_PIN (5U)

#define PD_PORT1_PHY_INTERRUPT_PORT (6U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN (9U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (4U)

#define PD_PORT1_EXTRA_SRC_PIN (1U)

#define PD_PORT1_EXTRA_SRC_PORT (6U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN (3U)

#define PD_PORT1_SHIELD2_DP4LANE_PORT (6U)

#define PD_PORT1_SHIELD2_XSD_PIN (0U)

#define PD_PORT1_SHIELD2_XSD_PORT (6U)

#define PD_PORT1_SHIELD2_ORIENT_PIN (4U)

#define PD_PORT1_SHIELD2_ORIENT_PORT (6U)

#define PD_PORT1_SHIELD2_HPD_PIN (2U)

#define PD_PORT1_SHIELD2_HPD_PORT (6U)

#define PD_PORT1_POWER_REQUEST_SW_PIN (15U)

#define PD_PORT1_POWER_REQUEST_SW_PORT (5U)

#define PD_PORT1_POWER_CHANGE_SW_PIN (1U)

#define PD_PORT1_POWER_CHANGE_SW_PORT (5U)
