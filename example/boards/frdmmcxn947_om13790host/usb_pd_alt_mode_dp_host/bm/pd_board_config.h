...
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN  (2U)
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (1U)

#define PD_PORT1_EXTRA_SRC_PIN  (30U)
#define PD_PORT1_EXTRA_SRC_PORT (0U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN  (29U)
#define PD_PORT1_SHIELD2_DP4LANE_PORT (0U)

#define PD_PORT1_SHIELD2_XSD_PIN  (21U)
#define PD_PORT1_SHIELD2_XSD_PORT (1U)

#define PD_PORT1_SHIELD2_ORIENT_PIN  (10U)
