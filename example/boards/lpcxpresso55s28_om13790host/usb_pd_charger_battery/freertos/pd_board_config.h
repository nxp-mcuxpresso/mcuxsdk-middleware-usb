...
#define PD_PORT1_PHY_INTERRUPT_PIN  (8U)
#define PD_PORT1_PHY_INTERRUPT_PORT (1U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN  (10U)
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (1U)

#define PD_PORT1_EXTRA_SRC_PIN  (7U)
#define PD_PORT1_EXTRA_SRC_PORT (1U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN  (15U)
#define PD_PORT1_SHIELD2_DP4LANE_PORT (0U)

#define PD_PORT1_SHIELD2_XSD_PIN  (4U)
#define PD_PORT1_SHIELD2_XSD_PORT (1U)

#define PD_PORT1_SHIELD2_ORIENT_PIN  (5U)
#define PD_PORT1_SHIELD2_ORIENT_PORT (1U)

#define PD_PORT1_SHIELD2_HPD_PIN  (6U)
#define PD_PORT1_SHIELD2_HPD_PORT (1U)
