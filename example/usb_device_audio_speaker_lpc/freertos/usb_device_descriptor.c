...
usb_device_interface_struct_t g_UsbDeviceAudioControInterface[] = {{
    USB_AUDIO_SPEAKER_CONTROL_INTERFACE_ALTERNATE_0,
    {
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    */
    ...
    USB_AUDIO_SPEAKER_CONTROL_INTERFACE_ALTERNATE_0, /* The value used to select the alternate setting for this
                                                        interface is 0   */
    ...
    */
    ...
    USB_AUDIO_SPEAKER_CONTROL_INTERFACE_ALTERNATE_0, /* Value used to select this alternate setting
